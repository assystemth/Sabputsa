<?php
// // ไฟล์นี้สามารถอัปโหลดรูปได้หลายไฟล์รูป http://192.168.1.108/Mukdahan/upload.php
...
// ไฟล์นี้สามารถอัปโหลดรูปได้ไฟล์เดียว http://192.168.1.108/Mukdahan/upload.php
$db = mysqli_connect('localhost', 'root', '', 'db_mukdahan');
