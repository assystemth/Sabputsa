...
class Prov_local_doc_model extends CI_Model
{
    ...
    //     // สร้างคำสั่ง SQL เพื่อดึงข้อมูล 15 รายการล่าสุดจากตาราง tbl_pnb_local_doc เรียงตามคอลัมน์ id จากมากไปน้อย
    //     $sql = "SELECT * FROM tbl_pnb_local_doc ORDER BY id DESC LIMIT 15";
    //     $result = $this->remote_db->query($sql);
