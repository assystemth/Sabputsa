<div class="text-center pages-head">
    <span class="font-pages-head">หนังสือราชการ สถ.จ.เพรชบูรณ์</span>
</div>
</div>
                    ...
                    <div class="col-9 font-pages-content ">
                        ...
                        for ($j = 1; $j <= 20; $j++) {
                            ...
                            if (!empty($rs[$urlKey])) {
                                ...
                                echo '<a href="' . htmlspecialchars($rs[$urlKey], ENT_QUOTES, 'UTF-8') . '" target="_blank" class="underline-hover">เอกสารแนบที่ ' . $j . '</a><br>';
