<div class="d-flex justify-content-between">
    ...
    <?php if ($qqueue->queue_status !== 'คิวได้ถูกยกเลิก' && $qqueue->queue_status !== 'คิวได้รับการยืนยัน') : ?>
        <?php if (!empty($latest_query)) : ?>
            <a class="btn btn-danger ml-auto cancel-complain-btn" data-target="#popupCancel">ยกเลิกคิว</a>
                ...
                <div class="col-sm-3">
                    <select class="form-control" name="queue_detail_status" required>
                        <?php if ($latest_query->queue_detail_status === 'รอยืนยันการจอง') : ?>
                            ...
                            <option class="text-center" value="คิวได้รับการยืนยัน">คิวได้รับการยืนยัน</option>    
                            <option class="text-center" value="คิวได้ถูกยกเลิก">คิวได้ถูกยกเลิก</option>
