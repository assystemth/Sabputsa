                ...
                <tbody>
                    ...
                    foreach ($query as $rs) { ?>
                        <tr role="row">
                            ...
                            <td>
                                <a href="<?= site_url('ita_year_backend/index_topic/' . $rs->ita_year_id); ?>"><i class="bi bi-plus-square fa-lg"></i></a>
                                <a href="<?= site_url('ita_year_backend/editing_year/' . $rs->ita_year_id); ?>"><i class="bi bi-pencil-square fa-lg "></i></a>
