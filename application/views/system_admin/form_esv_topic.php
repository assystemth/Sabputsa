...
<div id="popupInsert" class="popup">
    <div class="popup-content">
        <h4>เพิ่มข้อมูลแบบฟอร์มออนไลน์</h4>
        <form action="<?php echo site_url('form_esv_backend/add_topic'); ?> " method="post" class="form-horizontal">
            <div class="form-group row">
                <div class="col-sm-1 control-label">หัวข้อ</div>
                <div class="col-sm-5">
                    <input type="text" name="form_esv_topic_name" required class="form-control">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-black">จัดการข้อมูลแบบฟอร์มออนไลน์</h6>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    foreach ($query as $rs) { ?>
                        <tr role="row">
                            ...
                            <td class="limited-text"><?= $rs->form_esv_topic_name; ?></td>
                                    ...
                                    function confirmDelete(form_esv_topic_id) {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                window.location.href = "<?= site_url('form_esv_backend/del_form_esv_topic/'); ?>" + form_esv_topic_id;
                                            }
                                        });
                                    }
                                </script>
