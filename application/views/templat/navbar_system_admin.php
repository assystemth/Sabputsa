    ...
    <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo site_url('Moto_backend'); ?>">คำขวัญ</a>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <ul id="menuList" style="display: none;">
                ...
                <a href="<?php echo site_url('Moto_backend'); ?>" class="link">
                ...
                <a href="<?php echo site_url('P_public_backend'); ?>" class="link">
                ...
                <a href="<?php echo site_url('p_learder_backend'); ?>" class="link">
                    ...
                    <li class="hide">
                        <span>ข้อมูลกำนันผู้ใหญ่บ้าน</span>
                    </li>
                </a>
                ...
                <li class="hide">
                    <a href="<?php echo site_url('Elderly_aw_form_backend'); ?>" class="link">
                        <span>เอกสารเบี้ยผู้สูงอายุ/ผู้พิการ</span>
                    </a>
                </li>
                <li class="hide">
                    <a href="<?php echo site_url('Elderly_aw_ods_backend'); ?>" class="link">
                        <span>คำร้องเบี้ยผู้สูงอายุ/ผู้พิการ</span>
                    </a>
                </li>
                <li class="hide">
